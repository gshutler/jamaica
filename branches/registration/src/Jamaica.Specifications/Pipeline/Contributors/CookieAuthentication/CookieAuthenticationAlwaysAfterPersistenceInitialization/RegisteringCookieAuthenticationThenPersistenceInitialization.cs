...
{
    public class RegisteringCookieAuthenticationThenPersistenceInitialization : Specification
    {
        ...
        {
            Verify(Subject<PipelineRunner>().IndexOf<CookieAuthenticationContributor>(),
